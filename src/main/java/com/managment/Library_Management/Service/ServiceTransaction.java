...
public class ServiceTransaction implements ServiceIntrf<Transaction> {

	@Override
	public void addData(Transaction obj) {
	...
	@Override
	public Transaction getDetails(@Valid int id, String name) {
		// TODO Auto-generated method stub
		return null;
	}
